      ...
      <div className="max-w-4xl mx-auto space-y-6">
        <header className="flex justify-between items-center border-b border-current/10 pb-4">
          <div className="flex items-center gap-4">
            ...
            <div className="flex gap-2 text-[10px] opacity-30 font-en font-bold uppercase">
              <button onClick={() => { const blob = new Blob([JSON.stringify(entries)], {type:'application/json'}); const url = URL.createObjectURL(blob); const a = document.createElement('a'); a.href=url; a.download='archive.json'; a.click(); }}>Export</button>
